...
let ``BusinessDays excludes weekends`` () =
    ...
    let sched = Schedule.businessDays (DateTime(2024, 1, 1)) (DateTime(2024, 1, 12)) Set.empty
...
let ``BusinessDays excludes holidays`` () =
    ...
    let sched = Schedule.businessDays (DateTime(2024, 1, 1)) (DateTime(2024, 1, 12)) holidays
