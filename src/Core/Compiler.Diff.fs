...
module CompilerDiff =
    ...
    let rec collectDiffVars (expr: Expr) : Set<int> =
        ...
        | Lte(a, b)
        | And(a, b)
        | Or(a, b) -> Set.union (collectDiffVars a) (collectDiffVars b)
        | Select(c, t, f) ->
            collectDiffVars c
    ...
    let rec collectHyperDualVars (expr: Expr) : Set<int> =
        ...
        | Lte(a, b)
        | And(a, b)
        | Or(a, b) -> Set.union (collectHyperDualVars a) (collectHyperDualVars b)
        | Select(c, t, f) ->
    ...
    let rec forwardDiff (expr: Expr) (wrt: int) (accumDerivId: int -> int) : Expr =
        ...
        // Comparison and logical ops: piecewise constant → zero derivative
        | Gt _
        | Gte _
        | Lt _
        | Lte _
